...
class _DescriptionScreenState extends State<DescriptionScreen> {
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    InkWell(
                                        ...
                                        child: Image.network(
                                            "https://image.tmdb.org/t/p/w500${similar[index].posterPath}")),
                                    Padding(
                                      padding: const EdgeInsets.all(8.0),
                                      child: Row(
                                        children: [
  ...
  void getDetails() {
    ApiManager.getDetails(
        "https://api.themoviedb.org/3/movie/${id}?api_key=b4e0644efa9c3b27b91c3b8565b06e39&language=en-US")
        .then((value) {
  ...
  void getSimilar() {
    ApiManager.getSimilar(
        "https://api.themoviedb.org/3/movie/${id}/similar?api_key=b4e0644efa9c3b27b91c3b8565b06e39&language=en-US&page=1")
        .then((value) {
